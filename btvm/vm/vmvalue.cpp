...
VMValue::VMValue()               : value_flags(VMValueFlags::None), value_type(VMValueType::Null),   value_typedef(NULL), value_bits(-1), s_value_ref(NULL), ui_value(0)     { }
VMValue::VMValue(bool value)     : value_flags(VMValueFlags::None), value_type(VMValueType::Bool),   value_typedef(NULL), value_bits(-1), s_value_ref(NULL), ui_value(value) { }
VMValue::VMValue(int64_t value)  : value_flags(VMValueFlags::None), value_type(VMValueType::s64),    value_typedef(NULL), value_bits(-1), s_value_ref(NULL), ui_value(value) { }
